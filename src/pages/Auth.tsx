...
import { Mail, Lock, ArrowRight, Loader2, Eye, EyeOff, School, GraduationCap, Building2 } from 'lucide-react';
import { toast } from 'sonner';
const LOGO_URL = '/logo.png';

type SpaceType = 'student' | 'school';
...
const Auth = () => {
  ...
  const [space, setSpace] = useState<SpaceType>(spaceParam === 'school' ? 'school' : 'student');
  ...
  useEffect(() => {
    const handleRedirect = async () => {
      if (user) {
        ...
        if (schoolMembership) {
          // School admin - redirect to school dashboard
          navigate('/school');
          setCheckingRedirect(false);
          return;
        }
      ...
      <main className="flex-1 flex items-center justify-center px-4 pb-20">
        <div className="w-full max-w-md space-y-8 animate-slide-up">
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder={space === 'school' ? 'contact@etablissement.fr' : 'ton@email.com'}
                      value={email}
              ...
              <div className="mt-6 text-center space-y-2">
                ...
                {space === 'school' && isLogin && (
                  <Link 
                    to="/etablissements/inscription"
                    className="block text-sm text-muted-foreground hover:text-primary transition-colors"
                  >
                    Pas encore de compte ? Tester gratuitement
                  </Link>
                )}
              </div>
            </CardContent>
          ...
          <p className="text-center text-sm text-muted-foreground">
            {space === 'school' 
              ? 'Accompagnez vos étudiants dans leur réussite.' 
