        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <Button 
                size="lg" 
                className="gap-2 text-lg px-8 group"
          ...
          >
            {FEATURES.map((feature, index) => (
              <motion.div key={index} variants={fadeInUp} transition={{ duration: 0.5 }}>
                <Card className="border-0 bg-card hover-lift h-full">
                  <CardHeader>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {PRICING_TIERS.map((tier, index) => (
              <motion.div key={index} variants={fadeInUp} transition={{ duration: 0.5 }}>
                <Card 
                  className={`relative border-2 h-full ${tier.popular ? 'border-primary shadow-lg' : 'border-border'}`}
                >
                  {tier.popular && (
