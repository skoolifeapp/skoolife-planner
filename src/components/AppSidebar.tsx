        ...
        <div className="pt-6 border-t border-sidebar-border space-y-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <a
              ...
              className="w-9 h-9 flex items-center justify-center rounded-lg border border-sidebar-border hover:bg-sidebar-accent/50 transition-colors"
            >
            ...
            <Button
              ...
              className="w-10 h-10 rounded-full bg-sidebar-accent hover:bg-sidebar-accent/70"
            >
          ...
          >
            <Button
              variant="outline"
              size="sm"
              className="w-full justify-start gap-2 text-sidebar-foreground/70 hover:text-sidebar-foreground border-sidebar-border hover:bg-sidebar-accent/50 text-xs"
            >
          ...
          <Button
            ...
            className={cn(
              ...
              isSubscribed 
                ? "text-sidebar-foreground/70 hover:text-sidebar-foreground border-sidebar-border hover:bg-sidebar-accent/50" 
